    ...
    <x-slot>
        <div class="medewerkers-table-wrapper">
            <div class="before-medewerkers-table">
                ...
                <a href="{{ route('admin.medewerkers.create') }}" class="create-employee-button">+</a>
            </div>
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Edit knop -->
                        <a href="{{ route('admin.medewerkers.edit', $employee->id) }}" class="medewerkers-table-button">
                        ...
                        <!-- Delete formulier -->
                        <form method="POST"action="{{ route('admin.medewerkers.destroy', $employee->id) }}">
                            @csrf
                            @method('DELETE')
