    ...
    <x-slot>
        <div class="medewerkers-table-wrapper">
            <div class="before-medewerkers-table">
                ...
                <a href="/customers/create" class="create-employee-button">+</a>
            </div>
         ...
         @forelse($klanten as $klant)
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Edit knop -->
                        <a href="{{ route('edit_customer', $klant->id) }}" class="medewerkers-table-button">
                        ...
                        <!-- Delete formulier -->
                        <form method="POST"action="{{ route('delete_customer', $klant->id) }}">
                            @csrf
                            @method('DELETE')
