...
<head>
  <style>
      ...
      /* Ensure page doesn't flash to top */
      [data-turbo-preview] {
          display: none;
      }
  </style>
  ...
  <!-- Turbo Drive -->
  <script src="https://cdn.jsdelivr.net/npm/@hotwired/turbo@8.0.0/dist/turbo.min.js"></script>
    ...
    <ul class="navbar-nav nav-pills mx-auto d-flex align-items-center gap-2">
      ...
      @auth
        <li class="nav-item ms-3">
          <a href="{{ route('appointments.create') }}" class="btn btn-primary fw-bold">
            Maak afspraak
          </a>
        </li>
